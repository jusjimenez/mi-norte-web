...
const r=await page.evaluate(()=>{
  ...
  g1.freq='semanal';   const perSemana=goalPerPeriod(g1);
  g1.freq='mensual';
  return {
    g1needed:monthly, perQuincena, perSemana, perLabel,
    g1pace:goalPace(g1), g1rem:goalRemaining(g1),
    g2pace:goalPace(g2), g3pace:goalPace(g3), g3needed:goalPerPeriod(g3)
  };
});
console.log('g1 (300k, lleva 60k, +4m): falta',r.g1rem,'· /mes',r.g1needed,'· /quincena',r.perQuincena,'('+r.perLabel+') · /semana',r.perSemana);
...
const ok = errs.length===0 &&
  ...
  // frecuencia: quincena ~ mitad del mes; semana < quincena; etiqueta correcta
  r.perQuincena < r.g1needed && r.perQuincena > r.g1needed*0.45 && r.perQuincena < r.g1needed*0.6 &&
  r.perSemana < r.perQuincena && r.perLabel==='/quincena' &&
