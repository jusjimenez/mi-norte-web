...
const APP_VERSION = "v53"; // debe coincidir con el CACHE del service worker
...
showLock();
maybeShowGate();
/* Burbuja "pegar pago" (Apple Pay vía Atajos): disponible apenas abre. */
...
(function () {
  const fab = $("#paste-fab");
  if (fab && navigator.clipboard && navigator.clipboard.readText) { fab.hidden = false; fab.onclick = pastePayment; }
})();
